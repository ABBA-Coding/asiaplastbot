...
fullname = Iltimos ismingizni kiriting
phone_number = Iltimos telefon raqamingizni jo'nating
phone_number_kb = Yuborish
...
region_changed = Hudud o'zgartirildi!
...
send_cashback_code = Keshbekni olish uchun keshbek id-sini kiriting

incorrect_id = Noto'g'ri keshbek idsi kiritildi
